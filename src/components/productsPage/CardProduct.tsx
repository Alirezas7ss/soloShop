  ...
  return (
    <div className="  group relative h-[500px] w-[300px]  ">
      ...
      <div className="flex items-center justify-between">
        <div className="h-[400px] w-[1px] items-center  justify-center bg-light-custom-y-gradient group-hover:h-[500px] dark:bg-custom-y-gradient" />
      ...
      <div className="mr-[50%] h-[1px] w-[70%] translate-x-[50%] bg-light-custom-gradient group-hover:w-full dark:bg-custom-gradient  " />
    </div>
  )
}
